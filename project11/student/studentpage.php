...
<body>
    <div class="main">
        ...
        <div class="verf">
            ...
            <div class="prog">
                    Department:<img src="images/notyet.png" alt="" class="im"><br> 
                    Library:<img src="images/notyet.png" alt="" class="im"><br>
                    Survey:<img src="images/notyet.png" alt="" class="im"><br>
                    Games:<img src="images/notyet.png" alt="" class="im"><br>
                    Halls of Residence:<img src="images/notyet.png" alt="" class="im"><br>
                    Accounts:<img src="images/notyet.png" alt="" class="im"><br>
                    Dean of students:<img src="images/notyet.png" alt="" class="im"><br>
                    Academic:<img src="images/notyet.png" alt="" class="im"><br>
            </div>
        </div>
    </div>
    <div class="branch">
